...
function getToken(context) {
  ...
  console.log(chalk.dim(BASEURL + '/token?token=' + token) + '\n');
  ...
  return inquirer
    .prompt([
      ...
      },
      {
        type: 'input',
        name: 'tags',
        message: 'Tags ' + chalk.dim('such as git,bash,game'),
        validate: isSet,
        default: platform,
      },
    ])
...
function command(argv) {
  // No global config
  if (!utility.isGlobalDirectoryCreated()) {
...
export default {
  // Command's usage
  command: 'share <recordingFile>',
  // Command's description
  describe: 'Upload a recording file and get a link for an online player',
